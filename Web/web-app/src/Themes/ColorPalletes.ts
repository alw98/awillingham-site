...
export const ColorPalletes = {
	...
	prettyBlue: createPalleteFromHex('#16aab4', 10),
	trueBlue: createPalleteFromHex('#0d1dae', 10),
	teal: createPalleteFromHex('#31ddd3', 10),
	paleBlue: createPalleteFromHex('#559cc3', 10),
	trueGreen: createPalleteFromHex('#36b117', 10),
	paleGreen: createPalleteFromHex('#6caf73', 10),
