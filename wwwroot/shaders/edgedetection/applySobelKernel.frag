...
uniform float uLightnessBound;

vec4   xyzToRgb(vec4 c);
vec4   rgbToXyz(vec4 c);
vec4   xyzToLuv(vec4 c);
vec4   luvToXyz(vec4 c);
vec4   luvToLch(vec4 c);
vec4   lchToLuv(vec4 c);
vec4 hsluvToLch(vec4 c);
vec4 lchToHsluv(vec4 c);
vec4 hpluvToLch(vec4 c);
vec4 lchToHpluv(vec4 c);
vec4   lchToRgb(vec4 c);
vec4   rgbToLch(vec4 c);
vec4 hsluvToRgb(vec4 c);
vec4 rgbToHsluv(vec4 c);
vec4 hpluvToRgb(vec4 c);
vec4 rgbToHpluv(vec4 c);
vec4   luvToRgb(vec4 c);
...
void main() {
	...
	float gx = dx.x;
	float gy = dy.x;
	float edgeGradient = sqrt(pow(gx, 2.0) + pow(gy, 2.0));
